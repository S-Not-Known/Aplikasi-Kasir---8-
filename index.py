...
class WindowMainApp:
    def __init__(self, app, db_name='menu.db'):
        self.app = app
        app.title('Menu')
        ...
        my_image=CTk.CTkImage(light_image=Image.open("p.jpg"),
                    dark_image=Image.open("p.jpg"),
                    size=(800, 500))
...
class WindowTambahOrder(WindowMainApp):
    def __init__(self, app, db_name='menu.db'):
        self.connection = sqlite3.connect(db_name)
        self.cursor = self.connection.cursor()
...
class WindowTambahMenu(WindowMainApp):
    def __init__(self, app, db_name='menu.db'):
        self.connection = sqlite3.connect(db_name)
        self.cursor = self.connection.cursor()
...
class WindowHapusMenu(WindowMainApp):
    def __init__(self, app, db_name='menu.db'):
        self.connection = sqlite3.connect(db_name)
        self.cursor = self.connection.cursor()
...
WindowMainApp(app) # Menampilkan window sesuai nama kelas
WindowTambahOrder(app) # Menampilkan window sesuai nama kelas
WindowTambahMenu(app) # Menampilkan window sesuai nama kelas
WindowHapusMenu(app) # Menampilkan window sesuai nama kelas
